    ...
    <div class="container ">
        <div class="p-5 d-flex p-2 justify-content-center text-center">
            <div class="row">
                ...
                <?php
                    echo "The person who makes it has no need of it; <br>";
                    echo "the person who buys it has no use for it. <br>";
                    echo "The person who uses it can neither see nor feel it. <br>";                   
                    echo "What is it? <br>";
